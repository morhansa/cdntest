...
(function() {
/**
 * MagoArab JsdelivrCdn Extension
 *
 * @category  MagoArab
 * @package   MagoArab_JsdelivrCdn
 * @author    MagoArab <info@mago-ar.com>
 * @copyright Copyright (c) MagoArab (https://mago-ar.com)
 */
var config = {
    // No specific configuration needed for requirejs, but this file is included for future extensions
};
require.config(config);
})();
(function() {
